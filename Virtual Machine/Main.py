...
def translate_file(
    ...
    # extract file name
    full_name = os.path.basename(input_file.name)
    file_name_clean, extension = os.path.splitext(full_name)
    code_writer.set_file_name(file_name_clean)
